...
- **Configurable redox state**: O'Neill & Eggins (2002)[^cite-oneilleggins2002] iron-wüstite (IW) buffer with arbitrary $\Delta\mathrm{IW}$ shift, or Fischer et al. (2011)[^cite-fischer2011] IW
...
- Nicholls, H., Lichtenberg, T., Chatterjee, R.D., Guimond, C.M., Postolec, E., & Pierrehumbert, R.T. (2026). *Volatile-rich evolution of molten super-Earth L 98-59 d*. **Nature Astronomy**. \[[DOI](https://doi.org/10.1038/s41550-026-02815-8)\]
